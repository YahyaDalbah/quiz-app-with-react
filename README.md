# Quiz-App-With-React
#### Video Demo:  https://youtu.be/5tzNhgtniiA
#### Description:
this project is made with reactjs and css and html
it contains 4 main files

1. `index.js`: it's the place where i render the components to html

2. `App.js`: it contains the API call for the questions and it holded in state (React.useState hook) and it's passing data to question.js 
